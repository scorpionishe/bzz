...
Auto-fixes wrong-layout typing on macOS. MIT licensed. Replaces Punto Switcher; one-time payment instead of Caramba's subscription.
...
• Active CGEventTap that intercepts Enter before submission — works in Slack, Telegram, Notion
• Fuzzy matching catches typos: "gjljk;bv" still becomes "продолжим" even with a missed key
• Cmd+Z undo within 5 seconds, with per-app learning — the app remembers when you reject a correction
• 98K Russian dictionary with Snowball stemmer for accurate detection
...
## Comments to post on competitor pages
...
- Получите 5-10 апвоутов на свой submission от друзей
- Постоянно мониторьте — могут попросить дополнить инфу
- Тег "Self-Submitted" может появиться → нормально
- Через 1-2 недели — соберите статистику кликов из admin (если будет access)
